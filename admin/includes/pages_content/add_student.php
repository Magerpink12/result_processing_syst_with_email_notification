<?php
if (!empty($_POST['name']) && !empty($_POST['parent_name']) && !empty($_POST['current_class_id']) && !empty($_POST['parent_email']) && !empty($_POST['parent_phone']) && !empty($_POST['password'])) {
    ...
    if ($student->save()) {
        $message = notification('success', 'Student Added Successful');
        // redirect("?page=biometric");
        // $session->message($message);

    } else {
        $message = notification('danger', 'Error in Adding Student!');
        // $session->message($message);
    }
} else {
}
                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
                            ...
                            <div id="step-1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="email" id="last-name" name="parent_email" required="required"
                                            class="form-control form-control-sm">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Parent
                                        Phone
                                        Number</label>
                                    <div class="col-md-6 col-sm-6 ">
                            ...
                            <div id="step-2">
                                ...
                                <div class="form-group row">
                                    <label for="middle-name"
                                        class="col-form-label col-md-3 col-sm-3 label-align">Current Class</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select id="middle-name" class="form-control col form-control-sm"
