            ...
            if (in_array($_FILES["upload"]["type"], $allowedFileType)) {
                ...
                for ($row = 1; $row < $sheetCount; $row++) {
                    ...
                    for ($colum = 1; $colum < $colums; $colum++) {
                        if (in_array($spreadSheetAry[0][$colum], $subjects_decoded)) {
                            ...
                            if (!$roll_no == null) {
                                ...
                                $student_ca->first_ca = json_encode($ca);
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Upload 1st C.A Test Page</h3>
            </div>
        </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form method="GET" enctype="multipart/form-data"
                                        ...
                                        <input type="hidden" name="page" value="upload_1st_ca_test">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                ...
                                                <?php
                                                    $first_ca_arr = json_decode(array_shift($ca_tests)->first_ca ?? "[]", true) ?? array();

                                                    $aaa = array_keys($first_ca_arr);
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            foreach ($ca_tests as $ca_test) :
                                                                $first_ca_array = json_decode($ca_test->first_ca, true); ?>
                                                        <tr>
                                                            ...
                                                            <?php foreach ($aaa as $aa) : ?>
                                                            <th><?php echo $first_ca_array[$aa]  ?></th>
                                                            <?php endforeach ?>
