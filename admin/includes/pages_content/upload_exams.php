            ...
            for ($row = 1; $row < $sheetCount; $row++) {
                ...
                for ($colum = 1; $colum < $colums; $colum++) {
                    ...
                    if (!$roll_no == null) {
                        ...
                        $student_ca->exams = json_encode($ca);
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form method="GET" enctype="multipart/form-data"
                                        ...
                                        <input type="hidden" name="page" value="upload_exams">
                                        <div class="form-group row">
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <select name="class_id" type="text" class="form-control">
                                                        <?php if ($class_id ?? false) : ?>
                                                        <option value="<?php echo $class_id ?>">
                                                            <?php echo Classes::find_by_id($class_id)->name ?>
                                                        </option>
                                                        <?php else : ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                ...
                                                <?php
                                                    $exams_arr = json_decode(array_shift($ca_tests)->exams ?? "[]", true) ?? array();

                                                    $aaa = array_keys($exams_arr);
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            foreach ($ca_tests as $ca_test) :
                                                                $exams_array = json_decode($ca_test->exams, true); ?>
                                                        <tr>
