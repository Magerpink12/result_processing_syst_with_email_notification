<div class="modal fade bs-example-modal-lg" id="modal<?php echo $teacher->id ?>" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header bg-dark">
                <h4 class="modal-title text-light" id="myModalLabel">Update Teacher Detail
                </h4>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <div class="text-center">
                                <div id="display_image">
                                    ...
                                    <img alt="Charles Hall" src="<?php echo $teacher->picture ?>"
                                        class="rounded-circle img-responsive mt-2" width="115" height="115" />
                                    <?php endif;  ?>
                                </div>
                                <div class="mt-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="<?php echo $teacher->name ?>" type="text" id="first-name" name="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="<?php echo $teacher->email ?>" type="email" id="last-name" name="email"
                                required="required" class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Phone
                            Number</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input value="<?php echo $teacher->phone ?>" id="middle-name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="<?php echo $teacher->dob ?>" id="birthday"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control col form-control-sm " name="state">
                                <option value="<?php echo $teacher->state ?>"><?php echo $teacher->state ?></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control col form-control-sm" name="lga">
                                <option value="<?php echo $teacher->lga ?>"><?php echo $teacher->lga ?></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea class="form-control col" name="address"><?php echo $teacher->address ?></textarea>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Password</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input value="<?php // echo $teacher->password 
                                            ?>" id="middle-name"
